...
public:
    ...
    {   
        ...
        // this->name = name; //! Error: name variable is ambiguous (Multiple path for name variable) 
...
int main()
{
    ...
    // CT.display(); //! display() function is ambiguoug (Multiple path for display() function)
}